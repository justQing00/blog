...
由此,我们完成了一系列的打包性能、时间、大小的优化,当然我们也可以继续对业务公用库paas进行优化,因为我们只是使用了其中的一小部分功能却引入了一个高达几百k的东西paas.js、paas.css和他们的插件,这一步将会初步预计将会再次减少500k左右的压缩代码,时间估计将再次减少数十秒.我们也可以进一步使用[compression-webpack-plugin](https://github.com/webpack-contrib/compression-webpack-plugin)进行gzip压缩, 并开启[gzip服务](https://yq.aliyun.com/articles/68451),这将对我们的代码压再次缩60%左右.
